 ...
 */
class INET_API ModifiedEtherMACBase : public cSimpleModule //, public INotifiable
{
  protected:
...
//    int pauseUnitsRequested;        // requested pause duration, or zero -- examined at endTx
    ...
    unsigned long numFramesDroppedQueueFull;
